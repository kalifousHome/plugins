...
public class PluginFinder implements ActionListener {
	...
	/** Performs an action when an ActionEven occurs
	 * @param e
	...
	/** 
	 * Listing the files contained in the filtered directory 
	...
	/**
	 * Fires the Listeners when a plug-in represented by the file in parameter is added  
	 *@param file
	...
	/**
	 * Adds a plug-in listener to the list of listeners of the plug-in finder
	 * @param listener
	...
	/**
	 * Remove a plug-in listener from the list of listeners of the plug-in finder
	 * @param listener
